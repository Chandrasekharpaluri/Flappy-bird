...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Flappy Bird by Chandrasekhar paluri ")
    ...
    GAME_SOUNDS['die'] = pygame.mixer.Sound('gallery/audio/audio_die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('gallery/audio/audio_hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('gallery/audio/audio_point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('gallery/audio/audio_swoosh.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('gallery/audio/audio_wing.wav')
